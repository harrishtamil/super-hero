...
if(keyPressed == '70') {
      new_image('Copy of ironman_face.png'); 
console.log("f");
 }
  if(keyPressed == '66') { 
   ...
   console.log("t");
       ...
       new_image('hulk_legs.png'); console.log("r");
      }
       if(keyPressed == '82') {
             new_image('thor_righthand.png'); 
             onsole.log("r");
           }
            if(keyPressed == '72') { new_image('captenamarica_lefthand.png');
             console.log("h");
           }
